...
public class GeoJsonWriter implements Closeable, Externalizable {
	...
	enum WritingMode {
		DONE, INIT, FEATURE, FEATURE_POINT, COORDINATES, COORDINATES_ORIENTATION_SWITCH, COORDINATES_INTERIOR;
	}
	...
	public void writePointFeature(final String id, final String error, final String xCoordinate, final String yCoordinate)
			throws IOException {
		switch (mode) {
		case DONE:
		case FEATURE:
